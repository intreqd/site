...
gulp.task('copy:dns', function(callback) {
  return gulp
    .src([paths.base.base.dir + 'CNAME'])     // Source file
    .pipe(gulp.dest(paths.dist.base.dir)); // Output
});
...
gulp.task('build', gulp.series(gulp.parallel('clean:tmp', 'clean:dist', 'copy:all', 'copy:libs','copy:dns'), 'scss', 'html'));
